...
import {IMapCameralProps, CordinateArrayType} from '../types';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.textInput}>
        ...
        <TouchableOpacity
          style={styles.textPlaceHolderWrapper}
          onPress={() => toggleModal()}>
      ...
      <MapboxGL.MapView style={styles.map}>
        ...
        {destination[0] ? (
          <View>
            <Direction
              starting={starting as CordinateArrayType}
              destination={destination as CordinateArrayType}
            />
